...
func Test_user_Get(t *testing.T) {
	...
	for _, tt := range tests {
		t.Run(tt.name, func(t *testing.T) {
			...
			got, err := u.Get(tt.args.ctx, tt.args.params)
			if (err != nil) != tt.wantErr {
...
func Test_user_GetList(t *testing.T) {
	...
	for _, tt := range tests {
		t.Run(tt.name, func(t *testing.T) {
			...
			got, pagination, err := u.GetList(tt.args.ctx, tt.args.params)
			if (err != nil) != tt.wantErr {
...
func Test_user_Update(t *testing.T) {
	...
	for _, tt := range tests {
		t.Run(tt.name, func(t *testing.T) {
			...
			err = u.Update(tt.args.ctx, tt.args.updateParam, tt.args.selectParam)
			if (err != nil) != tt.wantErr {
				t.Errorf("user.Getlist() error = %v, wantErr %v", err, tt.wantErr)
				return
			}
